...
/**
 * Displays a link to the cup rounds administration page.
 *
 * @author Ingo Hofmann
 */
class CupRoundsLinkConverter implements IConverter {
	...
	public function toHtml($row) {
		$output = ' <a href=\'?site=managecuprounds&cup='. $row['id']. '\' title=\''.getMessage('manage_show_details') . '\' >'. $row['entity_cup_rounds'] .' <i class=\'icon-tasks\'></i></a>';
		return $output;
	}
