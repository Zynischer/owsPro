	...
	public function executeAction($parameters) {
		...
		if ($minHighscore) {
			...
			if ($minHighscore > $userinfo['highscore']) {
				throw new Exception(getMessage('freeclubs_msg_error_minhighscore', $minHighscore));
			}
		}
		...
		if (isset($teamsOfUser[$club['liga_id']])) {
			throw new Exception(getMessage('freeclubs_msg_error_no_club_from_same_league'));
		}
		...
		$this->_websoccer->addFrontMessage(new FrontMessage(MESSAGE_TYPE_SUCCESS,
				getMessage('freeclubs_msg_success'),''));
