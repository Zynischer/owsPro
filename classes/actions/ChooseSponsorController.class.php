...
class ChooseSponsorController implements IActionController {
	...
	public function executeAction($parameters) {
		...
		if ($sponsor) {
			throw new Exception(getMessage("sponsor_choose_stillcontract"));
		}
		...
		if (!$found) {
			throw new Exception(getMessage("sponsor_choose_novalidsponsor"));
		}
		...
		$this->_websoccer->addFrontMessage(new FrontMessage(MESSAGE_TYPE_SUCCESS,
				getMessage("sponsor_choose_success"),""));
