...
$mainTitle = getMessage("teamsgenerator_navlabel");
...
if (!$show) {
  ...
  <p><?php echo getMessage("teamsgenerator_intro"); ?></p>
...
elseif ($show == "generate") {
  ...
  if ($_POST['numberofteams'] <= 0) $err[] = getMessage("generator_validationerror_numberofitems");
  if ($_POST['numberofteams'] > 100) $err[] = getMessage("generator_validationerror_numberofitems_max");
