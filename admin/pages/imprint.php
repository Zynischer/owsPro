...
$mainTitle = getMessage('imprint_navlabel');
...
if (!$show) {
  ...
  <p><?php echo escapeOutput(getMessage('imprint_introduction')); ?></p>
...
elseif ($show == 'save') {
  ...
  if (!isset($_POST['content']) || !$_POST['content']) $err[] = getMessage('imprint_validationerror_content');
