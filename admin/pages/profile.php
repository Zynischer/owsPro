...
$mainTitle = getMessage("profile_title");
...
elseif ($show == "save") {
  ...
  if (!$_POST['email']) $err[] = getMessage("profile_validationerror_email");
  if ($_POST['newpassword'] && (strlen(trim($_POST['newpassword'])) < 5)) $err[] = getMessage("profile_validationerror_password_too_short");
  if ($_POST['newpassword'] != $_POST['repeatpassword']) $err[] = getMessage("profile_validationerror_wrong_repeated_password");
