...
$mainTitle = getMessage("managecuprounds_generate_navlabel");
...
if ($action == "generate" && isset($_POST["teams"]) && is_array($_POST["teams"])) {
	...
	echo createSuccessMessage(getMessage("managecuprounds_generate_success"), "");
	echo "<p><a href=\"?site=managecuprounds&cup=". $round["cup_id"] . "\" class=\"btn btn-primary\">" . getMessage("managecuprounds_generate_success_overviewlink") ."</a></p>";
}
...
?>
	...
	<div id="noCupPossibleAlert" class="alert" style="display: none;">
		<h5><?php echo getMessage("managecuprounds_generate_noroundspossible"); ?></h5>
	</div>
	<div id="possibleCupRoundsAlert" class="alert alert-info" style="display: none;">
		<h5><?php echo getMessage("managecuprounds_generate_possiblerounds"); ?>: <span id="roundsNo">0</span></h5>
	</div>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal">
	...
	<fieldset>
    	<legend><?php echo getMessage("managecuprounds_generate_formlabel"); ?> (<span id="numberOfTeamsSelected">0</span>)</legend>
	...
	<div class="form-actions">
		<input type="submit" class="btn btn-primary" accesskey="s" title="Alt + s" value="<?php echo getMessage("managecuprounds_generate_submitbutton"); ?>">
		<?php
