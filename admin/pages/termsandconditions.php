...
$mainTitle = getMessage("termsandconditions_navlabel");
...
if (!$show) {
  ...
  <p><?php echo getMessage("termsandconditions_introduction"); ?></p>

  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-inline">
	<input type="hidden" name="site" value="<?php echo $site; ?>">

	<label for="lang"><?php echo getMessage("termsandconditions_label_language"); ?></label>
	...
	<button type="submit" class="btn"><?php echo getMessage("button_display"); ?></button>
  </form>
...
elseif ($show == "save") {
  ...
  if (!isset($_POST['content']) || !strlen($_POST['content'])) $err[] = getMessage("imprint_validationerror_content");
  if (!is_writable($termsFile)) $err[] = getMessage("termsandconditions_err_filenotwritable", $termsFile);
