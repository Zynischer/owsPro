	...
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse"
				...
				title="<?php echo getMessage("manage_search_collapse"); ?>"> <i class="icon-filter"></i>
				<?php echo getMessage("manage_search_title"); ?>
			</a>
		</div>
			...
			<div class="accordion-inner">
				<form class="form-horizontal" name="frmSearch"
					...
					<div class="control-group">
						<div class="controls">
							<button type="submit" class="btn btn-primary"><?php echo getMessage("button_search"); ?></button>
							<a href="?site=<?php echo $site; ?>&entity=<?php echo $entity; ?>&filterreset=1" class="btn"><?php echo getMessage("button_reset"); ?></a>
						</div>
					</div>
				</form>
